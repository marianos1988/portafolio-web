      ...
      <article>
          ...
          <div className='container-box-skills'>
            ...
            <div className='box-skills'>
              ...
              <img src="src/img/logos/javascript.png" alt="Javascript" />
              <div className='points-skills'>
                <Radio
                  checked={true}
                  color='success'
            ...
            <div className='box-skills'>
              ...
              <img src="src/img/logos/react.png" alt="Reactjs" />
              <div className='points-skills'>
                <Radio
                  checked={true}
                  color='success'
            ...
            <div className='box-skills'>
              ...
              <img src="src/img/logos/nodejs.png" alt="NodeJs" />
              <div className='points-skills'>
                <Radio
                  checked={true}
                  color='success'
            ...
            <div className='box-skills'>
              ...
              <img src="src/img/logos/python.png" alt="Python" />
              <div className='points-skills'>
                <Radio
                  checked={true}
                  color='success'
            ...
            <div className='box-skills'>
              ...
              <img src="src/img/logos/mysql.png" alt="Mysql" />
              <div className='points-skills'>
                <Radio
                  checked={true}
                  color='success'
            ...
            <div className='box-skills'>
              ...
              <img src="src/img/logos/git-github.png" alt="Git-Github" />
              <div className='points-skills'>
                <Radio
                  checked={true}
                  color='success'
